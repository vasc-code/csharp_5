...
namespace _02._4.pesquisa
{
    internal class Pesquisa
    {
        ...
        private string Contem()
        {
            ...
            bool contem = txtPesquisa.Text.ToUpper()
                                       .Contains(textoBusca.ToUpper()); //implementar busca
        ...
        private string ComecaCom()
        {
            ...
            bool comecaCom = txtPesquisa.Text.StartsWith(textoBusca, StringComparison.InvariantCultureIgnoreCase);
            if (comecaCom)
            {
        ...
        private string TerminaCom()
        {
            ...
            var terminaCom = txtPesquisa.Text.EndsWith(textoBusca, StringComparison.InvariantCultureIgnoreCase); //implementar busca
